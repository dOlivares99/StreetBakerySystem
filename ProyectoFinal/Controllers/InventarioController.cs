...
namespace ProyectoFinal.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        public async Task<IActionResult> KardexProductoResultado(string fechaInicioId, string fechaFinalId, int productoId)
        {
            ...
            kardexInventarioVM.Producto = new Productos();
        ...
        public async Task<IActionResult> BuscarProducto(string term)
        {
            ...
            {
                var listaProductos = await _unidadTrabajo.Producto.ObtenerTodos(p => p.estado == "Activo");
                var data = listaProductos.Where(x => x.Nombre.Contains(term, StringComparison.OrdinalIgnoreCase) ||
